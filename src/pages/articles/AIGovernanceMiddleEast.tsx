...
export default function AIGovernanceMiddleEast() {
  return (
    <>
      <PageMeta
        title="AI Governance in the Middle East 2026 | Kudo Advisory"
        description="A practical overview of AI regulation in the UAE and Saudi Arabia, common governance gaps, and building AI governance that enables, not obstructs."
