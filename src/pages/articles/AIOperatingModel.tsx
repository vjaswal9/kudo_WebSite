...
export default function AIOperatingModel() {
  return (
    <>
      <PageMeta
        title="The AI Operating Model Explained | Kudo Advisory"
        description="Most enterprises have pockets of AI. Few have the operating model to scale it. Vijay Jaswal on what it is, why it matters, and how to build one."
